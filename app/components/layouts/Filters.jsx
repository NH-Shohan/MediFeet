          ...
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Arch Pain"
                className="h-4 w-4"
                defaultChecked={checkHandler("category", "Arch Pain")}
                onClick={(e) => handleClick(e.target)}
              />
              <span className="ml-2 text-gray-500"> Arch Pain </span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Arthritis"
                className="h-4 w-4"
                defaultChecked={checkHandler("category", "Arthritis")}
                onClick={(e) => handleClick(e.target)}
              />
              <span className="ml-2 text-gray-500"> Arthritis </span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
              <input
                name="category"
                type="checkbox"
                value="Back Discomfort"
                className="h-4 w-4"
                defaultChecked={checkHandler("category", "Back Discomfort")}
                onClick={(e) => handleClick(e.target)}
              />
              <span className="ml-2 text-gray-500"> Back Discomfort </span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Diabetes"
                className="h-4 w-4"
                defaultChecked={checkHandler("category", "Diabetes")}
                onClick={(e) => handleClick(e.target)}
              />
              <span className="ml-2 text-gray-500"> Diabetes </span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
