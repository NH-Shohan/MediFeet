        ...
        <SwiperSlide className="flex slider justify-center items-center gap-10">
          <div className="w-[300px] my-[30px] mx-auto shadow p-7 rounded-lg flex flex-col justify-between">
            <p className="overflow-hidden text-ellipsis h-[350px]">
              ...
              sports shoes. The online shopping experience was very easy and the
              interface was intuitive. I definitely will shop online for their
              shoes again. Comfortable and affordable. Delivery was great too.
            </p>
            <div>
              <Image
                src="/google.png"
                ...
                height="50"
              />
              <h1 className="text-lg font-semibold">Reviewer Name</h1>
              <div className="flex items-center">
                <p>5.0</p>
                <div class="ml-2 flex items-center mb-1 text-[#FFA827]">
                  <svg
                    class="w-4 h-4 mr-1"
                    aria-hidden="true"
